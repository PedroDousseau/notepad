  ...
  public SignUpDialog(Frame parent) {
    ...
    btnCadastrar.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if(pass.equals(conf)) { 
          SignUp.cadastrarNovo(tfNome.getText(), tfEmail.getText(), pass);
          JOptionPane.showMessageDialog(SignUpDialog.this, "Cadastro realizado com sucesso!",
              "Cadastro", JOptionPane.INFORMATION_MESSAGE);
          dispose();
        }
        else
          JOptionPane.showMessageDialog(SignUpDialog.this, "Senhas não conferem.",
